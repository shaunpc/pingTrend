...
if __name__ == '__main__':
    ...
    l_min, = ax.plot(manager.ping_time or [], manager.ping_min or [], "--g", linewidth=1, label='Min')
    l_ave, = ax.plot(manager.ping_time or [], manager.ping_ave or [], "-b", linewidth=2, label='Ave')
    l_max, = ax.plot(manager.ping_time or [], manager.ping_max or [], "--y", linewidth=1, label='Max')
    l_err, = ax_err.plot(manager.ping_time or [], manager.ping_err or [], "-r", linewidth=3, label='Error Count')
